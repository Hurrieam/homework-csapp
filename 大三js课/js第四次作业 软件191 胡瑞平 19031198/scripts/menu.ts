var select_a: HTMLSelectElement = <HTMLSelectElement>document.getElementsByClassName("select")[0];

var select_b: HTMLSelectElement = <HTMLSelectElement>document.getElementsByClassName("select")[1];

var select_c: HTMLSelectElement = <HTMLSelectElement>document.getElementsByClassName("select")[2];

var select_a_arr: string[] = ["1", "2", "3"];

var select_b_arr: string[][] = [
    ["1.1", "1.2", "1.3"],
    ["2.1", "2.2", "2.3"],
    ["3.1", "3.2", "3.3"]
];

var select_c_arr: string[][][] = [
    [
        ["1.1.1", "1.1.2", "1.1.3"],
        ["1.2.1", "1.2.2", "1.2.3"],
        ["1.3.1", "1.3.2", "1.3.3"]
